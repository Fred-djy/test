...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('qNVfQAu4Ya', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('-+AvXFv7pu', 0, 'j+L5yA333MKr7zPGXeWoDO', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[3].'\\src\\FredBundle\\Resources\\config\\doctrine') => 'FredBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'FredBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('FredBundle' => 'FredBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_40217a5d600338760b849388e8c7265a1e5a6d2a698c50fa6e6bd74599489de9');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Noel\\WebBundle/Resources/views'), 'NoelWeb');
        $instance->addPath(($this->targetDirs[3].'\\src\\App\\AlipayBundle/Resources/views'), 'AppAlipay');
        $instance->addPath(($this->targetDirs[3].'\\src\\Api\\Bundle/Resources/views'), 'Api');
        $instance->addPath(($this->targetDirs[3].'\\src\\Caishe\\Bundle/Resources/views'), 'Caishe');
        $instance->addPath(($this->targetDirs[3].'\\src\\CaishenBundle/Resources/views'), 'Caishen');
        $instance->addPath(($this->targetDirs[3].'\\src\\FredBundle/Resources/views'), 'Fred');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('4ebd8470c48e7a289a38cdf5a019612f7b72e4c9');
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('8KhDgzJnrE', 0, 'j+L5yA333MKr7zPGXeWoDO', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('58cf460bd6d365.26964316')), true);
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'NoelWebBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\Noel\\WebBundle'),
                    'namespace' => 'Noel\\WebBundle',
                ),
                'AppAlipayBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\App\\AlipayBundle'),
                    'namespace' => 'App\\AlipayBundle',
                ),
                'ApiBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\Api\\Bundle'),
                    'namespace' => 'Api\\Bundle',
                ),
                'CaisheBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\Caishe\\Bundle'),
                    'namespace' => 'Caishe\\Bundle',
                ),
                'CaishenBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\CaishenBundle'),
                    'namespace' => 'CaishenBundle',
                ),
                'FredBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\FredBundle'),
                    'namespace' => 'FredBundle',
                ),
                'DebugBundle' => array(
                    'parent' => NULL,
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'NoelWebBundle' => 'Noel\\WebBundle\\NoelWebBundle',
                'AppAlipayBundle' => 'App\\AlipayBundle\\AppAlipayBundle',
                'ApiBundle' => 'Api\\Bundle\\ApiBundle',
                'CaisheBundle' => 'Caishe\\Bundle\\CaisheBundle',
                'CaishenBundle' => 'CaishenBundle\\CaishenBundle',
                'FredBundle' => 'FredBundle\\FredBundle',
            ...
            'secret' => '4ebd8470c48e7a289a38cdf5a019612f7b72e4c9',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '4ebd8470c48e7a289a38cdf5a019612f7b72e4c9',
